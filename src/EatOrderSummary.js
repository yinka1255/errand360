  ...
  render() {
    ...
    return (
      <View style = {styles.body}>
        ...
        <TouchableOpacity  onPress={() => this.props.navigation.navigate('EatDeliveryAddress')}>
          ...
          <View style={styles.cView}>
            <View style={styles.itemView}>
              <View style={styles.item1}>
                ...
                <Text style = {styles.txt}>Joy Green</Text>
              </View>
              <View style={styles.item2}>
                <Text style = {styles.label}>Contact Phone</Text>
                <Text style = {styles.txt}>08098987676</Text>
              </View>
            </View>
            <View style={styles.itemView}>
              <View style={styles.item3}>
                <Text style = {styles.label}>Address</Text>
                <Text style = {styles.txt}>808 broad street, Lagos Island, Lagos</Text>
              </View>
            </View>
            <View style={styles.itemView}>
              <View style={styles.item3}>
            ...
            <View style={styles.itemView1}>
              <View style={styles.item1}>
                <Text style = {styles.label}>Tasty fried rice</Text>
                <Text style = {styles.label}>Tasty fried rice</Text>
                <Text style = {styles.label}>Tasty fried rice</Text>
                <Text style = {styles.labelZ}>Total</Text>
              </View>
              <View style={styles.item2}>
                <Text style = {styles.label}>N4,500.00</Text>
                <Text style = {styles.label}>N4,500.00</Text>
                <Text style = {styles.label}>N4,500.00</Text>
                <Text style = {styles.labelZ}>N13,500.00</Text>
              </View>
            </View>
